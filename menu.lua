...
Menu.Banner = {
    enabled = true,
    imageUrl = "https://i.imgur.com/8Hstaj4.png",
    height = 120
}
...
Menu.Colors = {
    Primary = { r = 255, g = 140, b = 0 },      -- Orange (main accent)
    Secondary = { r = 40, g = 40, b = 40 },     -- Dark gray
    Background = { r = 10, g = 10, b = 10 },    -- Almost black background
    Text = { r = 255, g = 255, b = 255 },       -- White text
    TextMuted = { r = 180, g = 180, b = 180 },  -- Gray text
    Border = { r = 60, g = 60, b = 60 },        -- Border color
    Success = { r = 76, g = 175, b = 80 },      -- Green for success states
    Warning = { r = 255, g = 193, b = 7 },      -- Yellow for warnings
    Error = { r = 244, g = 67, b = 54 }         -- Red for errors
}
...
function Menu.ApplyTheme(themeName)
    if not themeName or type(themeName) ~= "string" then
        themeName = "BlackOrange"
    end
    
    local themeLower = string.lower(themeName)
    Menu.CurrentTheme = themeName
    
    if themeLower == "blackorange" then
        Menu.Colors.Primary = { r = 255, g = 140, b = 0 }
        Menu.Colors.Secondary = { r = 40, g = 40, b = 40 }
        Menu.Colors.Background = { r = 10, g = 10, b = 10 }
        Menu.Colors.Text = { r = 255, g = 255, b = 255 }
        Menu.Colors.TextMuted = { r = 180, g = 180, b = 180 }
        Menu.Colors.Border = { r = 60, g = 60, b = 60 }
        Menu.Banner.imageUrl = "https://i.imgur.com/8Hstaj4.png"
        Menu.CurrentTheme = "BlackOrange"
    elseif themeLower == "purple" then
        Menu.Colors.Primary = { r = 148, g = 0, b = 211 }
        Menu.Colors.Secondary = { r = 40, g = 40, b = 40 }
        Menu.Colors.Background = { r = 10, g = 10, b = 10 }
        Menu.Banner.imageUrl = "https://i.imgur.com/a/s6FTtiL"
        Menu.CurrentTheme = "Purple"
    elseif themeLower == "red" then
        Menu.Colors.Primary = { r = 255, g = 0, b = 0 }
        Menu.Colors.Secondary = { r = 40, g = 40, b = 40 }
        Menu.Colors.Background = { r = 10, g = 10, b = 10 }
...
function Menu.GetScaledPosition()
    ...
    return {
        ...
        borderWidth = Menu.Position.borderWidth * scale
    }
end
...
function Menu.DrawText(x, y, text, size_px, r, g, b, a, font)
    local scale = Menu.Scale or 1.0
...
function Menu.DrawHeader()
    ...
    if Menu.Banner.enabled then
        if Menu.bannerTexture and Menu.bannerTexture > 0 and Susano and Susano.DrawImage then
            ...
            Menu.DrawRect(x, y, width, height, Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 255)
    ...
    local borderWidth = scaledPos.borderWidth
    if borderWidth > 0 then
        Menu.DrawRect(x, y, width, borderWidth, Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
        Menu.DrawRect(x, y + height - borderWidth, width, borderWidth, Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
        Menu.DrawRect(x, y, borderWidth, height, Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
        Menu.DrawRect(x + width - borderWidth, y, borderWidth, height, Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
    end
end
...
function Menu.DrawScrollbar(x, startY, visibleHeight, selectedIndex, totalItems, isMainMenu, menuWidth)
    ...
    local bgR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0) or 1.0
    local bgG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0) or 0.55
    local bgB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0) or 0.0
...
function Menu.DrawTabs(category, x, startY, width, tabHeight)
    ...
    for i, tab in ipairs(category.tabs) do
        ...
        if isSelected then
            ...
            local baseR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0) or 1.0
            local baseG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0) or 0.55
            local baseB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0) or 0.0

            if Susano and Susano.DrawRectFilled then
                Susano.DrawRectFilled(drawX, startY, drawWidth, tabHeight, baseR, baseG, baseB, 0.9, 0.0)
            else
                Menu.DrawRect(drawX, startY, drawWidth, tabHeight, baseR * 255, baseG * 255, baseB * 255, 230)
            end
        else
            if Susano and Susano.DrawRectFilled then
                Susano.DrawRectFilled(tabX, startY, currentTabWidth, tabHeight,
                    Menu.Colors.Background.r / 255.0, Menu.Colors.Background.g / 255.0, Menu.Colors.Background.b / 255.0, 0.7, 0.0)
            else
                Menu.DrawRect(tabX, startY, currentTabWidth, tabHeight,
                    Menu.Colors.Background.r, Menu.Colors.Background.g, Menu.Colors.Background.b, 180)
            end
        end
        ...
        if isSelected then
            ...
            textR = Menu.Colors.TextMuted.r / 255.0
            textG = Menu.Colors.TextMuted.g / 255.0
            textB = Menu.Colors.TextMuted.b / 255.0
        end
...
function Menu.DrawItem(x, itemY, width, itemHeight, item, isSelected)
    ...
    if item.isSeparator then
        if Susano and Susano.DrawRectFilled then
            Susano.DrawRectFilled(x, itemY, width, itemHeight,
                Menu.Colors.Background.r / 255.0, Menu.Colors.Background.g / 255.0, Menu.Colors.Background.b / 255.0, 0.8, 0.0)
        else
            Menu.DrawRect(x, itemY, width, itemHeight, Menu.Colors.Background.r, Menu.Colors.Background.g, Menu.Colors.Background.b, 200)
        end
        ...
        if item.separatorText then
            ...
            Menu.DrawText(textX, textY, item.separatorText, 14,
                Menu.Colors.Primary.r / 255.0, Menu.Colors.Primary.g / 255.0, Menu.Colors.Primary.b / 255.0, 1.0)
            ...
            if leftBarWidth > 0 and leftBarX >= x + 15 then
                if Susano and Susano.DrawRectFilled then
                    Susano.DrawRectFilled(leftBarX, math.floor(barY), leftBarWidth, barHeight,
                        Menu.Colors.Primary.r / 255.0, Menu.Colors.Primary.g / 255.0, Menu.Colors.Primary.b / 255.0, 0.5,
                        0)
                else
                    Menu.DrawRect(leftBarX, math.floor(barY), leftBarWidth, barHeight,
                        Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 128)
                end
            end
    ...
    if Susano and Susano.DrawRectFilled then
        Susano.DrawRectFilled(x, itemY, width, itemHeight,
            Menu.Colors.Background.r / 255.0, Menu.Colors.Background.g / 255.0, Menu.Colors.Background.b / 255.0, 0.8,
            0.0)
    else
        Menu.DrawRect(x, itemY, width, itemHeight,
            Menu.Colors.Background.r, Menu.Colors.Background.g, Menu.Colors.Background.b, 200)
    end
        ...
        if Menu.GradientType == 2 then
            ...
            for step = 0, gradientSteps - 1 do
                ...
                if actualStepWidth > 0 then
                    ...
                    if Susano and Susano.DrawRectFilled then
                        Susano.DrawRectFilled(stepX, selectorY, actualStepWidth, selectorHeight, baseR, baseG, baseB, alpha, 0.0)
                    else
                        Menu.DrawRect(stepX, selectorY, actualStepWidth, selectorHeight, baseR * 255, baseG * 255, baseB * 255, math.floor(alpha * 255))
                    end
                end
            end
        else
            if Susano and Susano.DrawRectFilled then
                Susano.DrawRectFilled(selectorX, drawY, width - 1, itemHeight, baseR, baseG, baseB, 0.9, 0.0)
            else
                Menu.DrawRect(selectorX, drawY, width - 1, itemHeight, baseR * 255, baseG * 255, baseB * 255, 230)
            end
        end

        if Susano and Susano.DrawRectFilled then
            Susano.DrawRectFilled(selectorX, drawY, 3, itemHeight, baseR * 1.2, baseG * 1.2, baseB * 1.2, 1.0, 0.0)
        else
            Menu.DrawRect(selectorX, drawY, 3, itemHeight,
                math.min(255, baseR * 1.2 * 255), math.min(255, baseG * 1.2 * 255), math.min(255, baseB * 1.2 * 255), 255)
        end
    end
    ...
    if isSelected then
        ...
        textR = Menu.Colors.Text.r / 255.0
        textG = Menu.Colors.Text.g / 255.0
        textB = Menu.Colors.Text.b / 255.0
    end
    ...
    if item.type == "toggle" then
        ...
        if item.value then
            local tR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0) or 1.0
            local tG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0) or 0.55
            local tB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0) or 0.0
        ...
        if item.hasSlider then
            ...
            if percent > 0 then
                if Susano and Susano.DrawRectFilled then
                    local accentR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0 * 1.2) or 1.0
                    local accentG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0 * 1.2) or 0.66
                    local accentB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0 * 1.2) or 0.0
                    ...
                    local accentR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and math.min(255, Menu.Colors.Primary.r * 1.2) or 255
                    local accentG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and math.min(255, Menu.Colors.Primary.g * 1.2) or 168
                    local accentB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and math.min(255, Menu.Colors.Primary.b * 1.2) or 0
            ...
            Menu.DrawText(valueX, valueY, valueText, 10,
                Menu.Colors.TextMuted.r / 255.0, Menu.Colors.TextMuted.g / 255.0, Menu.Colors.TextMuted.b / 255.0, 1.0)
        end
    elseif item.type == "toggle_selector" then
        ...
        if item.value then
            ...
            if Susano and Susano.DrawRectFilled then
                Susano.DrawRectFilled(toggleX, toggleY, toggleWidth, toggleHeight, tR, tG, tB, 1.0, toggleRadius)
            else
                Menu.DrawRoundedRect(toggleX, toggleY, toggleWidth, toggleHeight, tR * 255, tG * 255, tB * 255, 255, toggleRadius)
            end
        else
            if Susano and Susano.DrawRectFilled then
                Susano.DrawRectFilled(toggleX, toggleY, toggleWidth, toggleHeight, 0.2, 0.2, 0.2, 1.0, toggleRadius)
            else
                Menu.DrawRoundedRect(toggleX, toggleY, toggleWidth, toggleHeight, 51, 51, 51, 255, toggleRadius)
            end
        end
        ...
        if item.options then
            ...
            Menu.DrawText(selectorX, textY, "<", selectorSize,
                Menu.Colors.Primary.r / 255.0, Menu.Colors.Primary.g / 255.0, Menu.Colors.Primary.b / 255.0, 0.8)
    ...
    elseif item.type == "slider" then
        ...
        Menu.DrawText(valueX, valueY, valueText, 11,
            Menu.Colors.TextMuted.r / 255.0, Menu.Colors.TextMuted.g / 255.0, Menu.Colors.TextMuted.b / 255.0, 1.0)
    elseif item.type == "selector" and item.options then
        ...
        if isWardrobeSelector then
            ...
            Menu.DrawText(selectorX, textY, selectorText, 17,
                Menu.Colors.Primary.r / 255.0, Menu.Colors.Primary.g / 255.0, Menu.Colors.Primary.b / 255.0, 1.0)
        else
            local fullText = "< " .. selectedOption .. " >"
            local selectorWidth = 0
...
function Menu.DrawCategories()
    ...
    if Susano and Susano.DrawRectFilled then
        Susano.DrawRectFilled(x, itemY, width, mainMenuHeight, baseR, baseG, baseB, 0.9, 0)
    else
        Menu.DrawRect(x, itemY, width, mainMenuHeight, baseR * 255, baseG * 255, baseB * 255, 230)
    end
    ...
    if Menu.TopLevelTabs then
        ...
        for i, tab in ipairs(Menu.TopLevelTabs) do
            ...
            if isSelected then
                ...
                local accentR = baseR * 1.1
                local accentG = baseG * 1.1
                local accentB = baseB * 1.1
                
                if Susano and Susano.DrawRectFilled then
                    Susano.DrawRectFilled(drawX, itemY, drawWidth, mainMenuHeight, accentR, accentG, accentB, 0.9, 0)
                else
                    Menu.DrawRect(drawX, itemY, drawWidth, mainMenuHeight,
                        math.min(255, accentR * 255), math.min(255, accentG * 255), math.min(255, accentB * 255), 230)
                end
                
                if Susano and Susano.DrawRectFilled then
                    Susano.DrawRectFilled(drawX, itemY + mainMenuHeight - 2, drawWidth, 2, accentR * 1.3, accentG * 1.3, accentB * 1.3, 1.0, 0)
                else
                    Menu.DrawRect(drawX, itemY + mainMenuHeight - 2, drawWidth, 2,
                        math.min(255, accentR * 1.3 * 255), math.min(255, accentG * 1.3 * 255), math.min(255, accentB * 1.3 * 255), 255)
                end
            end
            ...
            if not isSelected then
                r = Menu.Colors.TextMuted.r / 255.0
                g = Menu.Colors.TextMuted.g / 255.0
                b = Menu.Colors.TextMuted.b / 255.0
            end
            
            Menu.DrawText(textX, textY, text, textSize, r, g, b, 1.0)
        end
    else
        local textY = itemY + mainMenuHeight / 2 - 7
        local estimatedTextWidth = string.len(Menu.Categories[1].name) * 9
        local textX = x + (width / 2) - (estimatedTextWidth / 2)
        Menu.DrawText(textX, textY, Menu.Categories[1].name, 16, 1.0, 1.0, 1.0, 1.0)
    end
    ...
    for displayIndex = 1, math.min(maxVisible, totalCategories) do
        ...
        if categoryIndex <= #Menu.Categories then
            ...
            Menu.DrawText(textX, textY, category.name, 17, textR, textG, textB, 1.0)

            local chevronX = x + width - 22
            Menu.DrawText(chevronX, textY, ">", 17,
                Menu.Colors.Primary.r / 255.0, Menu.Colors.Primary.g / 255.0, Menu.Colors.Primary.b / 255.0, 1.0)
        end
    end
...
function Menu.DrawLoadingBar(alpha)
    ...
    local accentR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0) or 1.0
    local accentG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0) or 0.55
    local accentB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0) or 0.0
...
function Menu.DrawFooter()
    ...
    if Susano and Susano.DrawRectFilled then
        Susano.DrawRectFilled(x, footerY, footerWidth, footerHeight,
            Menu.Colors.Background.r / 255.0, Menu.Colors.Background.g / 255.0, Menu.Colors.Background.b / 255.0, 1.0,
            footerRounding)
    else
        Menu.DrawRoundedRect(x, footerY, footerWidth, footerHeight,
            Menu.Colors.Background.r, Menu.Colors.Background.g, Menu.Colors.Background.b, 255, footerRounding)
    end
    ...
    Menu.DrawText(currentX, footerTextY, footerText, footerSize,
        Menu.Colors.Primary.r / 255.0, Menu.Colors.Primary.g / 255.0, Menu.Colors.Primary.b / 255.0, 1.0)
    ...
    Menu.DrawText(posX, footerTextY, posText, footerSize,
        Menu.Colors.TextMuted.r / 255.0, Menu.Colors.TextMuted.g / 255.0, Menu.Colors.TextMuted.b / 255.0, 1.0)
    
    local borderWidth = scaledPos.borderWidth
    if borderWidth > 0 then
        Menu.DrawRect(x, footerY, footerWidth, borderWidth,
            Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
        Menu.DrawRect(x, footerY + footerHeight - borderWidth, footerWidth, borderWidth,
            Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
        Menu.DrawRect(x, footerY, borderWidth, footerHeight,
            Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
        Menu.DrawRect(x + footerWidth - borderWidth, footerY, borderWidth, footerHeight,
            Menu.Colors.Primary.r, Menu.Colors.Primary.g, Menu.Colors.Primary.b, 200)
    end
end
...
function Menu.DrawKeySelector(alpha)
    ...
    local menuR = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0) or 1.0
    local menuG = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0) or 0.55
    local menuB = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0) or 0.0
    ...
    for i, seg in ipairs(segments) do
        ...
        for i = 0, segSteps - 1 do
            ...
            if currentY >= menuBarEndY and currentY < itemsY then
                ...
                if Susano and Susano.DrawRectFilled then
                    Susano.DrawRectFilled(x, currentY, width, drawH,
                        Menu.Colors.Background.r / 255.0, Menu.Colors.Background.g / 255.0, Menu.Colors.Background.b / 255.0, backgroundAlpha, 0)
                else
                    Menu.DrawRect(x, currentY, width, drawH,
                        Menu.Colors.Background.r, Menu.Colors.Background.g, Menu.Colors.Background.b, math.floor(backgroundAlpha * 255))
                end
            end
        end
        end
...
function Menu.DrawInputWindow()
    ...
    local r = (Menu.Colors.Primary and Menu.Colors.Primary.r) and (Menu.Colors.Primary.r / 255.0) or 1.0
    local g = (Menu.Colors.Primary and Menu.Colors.Primary.g) and (Menu.Colors.Primary.g / 255.0) or 0.55
    local b = (Menu.Colors.Primary and Menu.Colors.Primary.b) and (Menu.Colors.Primary.b / 255.0) or 0.0
